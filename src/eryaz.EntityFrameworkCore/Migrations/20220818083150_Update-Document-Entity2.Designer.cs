...
namespace eryaz.Migrations
{
    ...
    [Migration("20220818083150_Update-Document-Entity2")]
    partial class UpdateDocumentEntity2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eryaz.Warehouses.Warehouse", b =>
                {
                    ...
                    b.Property<string>("AmbarKodu")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("AmbarTipi")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eryaz.Documents.Document", b =>
                {
                    b.HasOne("eryaz.Warehouses.Warehouse", "Ambar")
                        .WithMany()
                        .HasForeignKey("AmbarId");

                    b.HasOne("eryaz.Customers.Customer", "Musteri")
                        .WithMany()
