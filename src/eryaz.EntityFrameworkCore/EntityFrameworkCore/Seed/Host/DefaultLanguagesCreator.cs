...
namespace eryaz.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly eryazDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = eryazConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(eryazDbContext context)
        {
            _context = context;
        }
