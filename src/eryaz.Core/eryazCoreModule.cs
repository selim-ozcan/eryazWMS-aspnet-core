...
namespace eryaz
{
    ...
    public class eryazCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            eryazLocalizationConfigurer.Configure(Configuration.Localization);

            // Enable this line to create a multi-tenant application.
            Configuration.MultiTenancy.IsEnabled = eryazConsts.MultiTenancyEnabled;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(eryazCoreModule).GetAssembly());
        }
