...
{
    public abstract class eryazWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static eryazWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(eryazWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<eryazDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<eryazDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<eryazDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<eryazDbContext, Task<T>> func)
        {
            T result;
